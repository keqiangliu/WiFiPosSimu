close all;clear;clc;
load test_result_sigma;
result=sigma_clean_result;
...
legend('APN  = 3','APN  = 5','APN  = 10','APN  = 15','APN  = 20','Location','southeast');
set(gca,'XTick',1:2:15,'fontname','Times New Roman','fontsize',13,'fontweight','bold');
xlabel('\it\sigma \rm\bf(dB)');
ylabel('RMSE(m)');
axis([1 15 0 6.5]);
grid on;
...
h=colorbar('SouthOutside');caxis([1 15]);
set(get(h,'title'),'string','\it \sigma \rm\bf(dB)','fontname','Times New Roman','fontsize',13,'fontweight','bold');
set(h,'xtick',1:1:15,'fontname','Times New Roman','fontsize',13,'fontweight','bold');
